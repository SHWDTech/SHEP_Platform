namespace VehicleDustMonitor.Xamarin.Component
{
    public static class VehicleRecordEntity
    {
        ...
        public static readonly string SqlCreateEntitis =
            $"CREATE TABLE {TableName} ({ColumnNameId} INTEGER PRIMARY KEY AUTOINCREMENT, {ColumnNameDevId} INTEGER, {ColumnNameRecordName} TEXT, {ColumnNameComment} TEXT, {ColumnNameStartDateTime} TEXT, {ColumnNameEndDateTIme} TEXT)";
