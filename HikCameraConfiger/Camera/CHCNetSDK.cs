...
namespace HikCameraConfiger.Camera
{
	/// <summary>
	/// CHCNetSDK 的摘要说明。
	/// </summary>
	public class CHCNetSDK
	{
		...
		**********************************************************/
		...
		/*********************************************************
		Function:	NET_DVR_ActivateDevice
		Desc:		激活设备。
		Input:
		Output:
		Return:	TRUE表示成功，FALSE表示失败。
		**********************************************************/
		[DllImport("HCNetSDK.dll")]
		public static extern bool NET_DVR_ActivateDevice(string sDVRIP, uint wDVRPort, IntPtr lpActivateCfg);
